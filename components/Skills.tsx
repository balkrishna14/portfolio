      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-8">
          <button
            ...
            className={cn(
              "px-3.5 py-1.5 text-xs font-mono rounded-full transition-all border cursor-pointer",
              selectedCategory === "all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCategories.map((category) => {
            ...
            return (
              <div
                key={category.id}
                className="p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 shadow-xs hover:border-zinc-300 dark:hover:border-zinc-700 transition-all flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-5">
                    {category.skills.map((skill) => (
                      <div
                        key={skill}
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/80 text-xs font-mono text-zinc-800 dark:text-zinc-200 hover:border-emerald-500/40 transition-colors"
                      >
                ...
                <div className="mt-6 pt-3 border-t border-zinc-100 dark:border-zinc-800/60 text-[11px] font-mono text-zinc-500 dark:text-zinc-400 flex items-center justify-between">
