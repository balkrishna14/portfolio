...
export function Education() {
  ...
  return (
    <section id="education" className="py-16 sm:py-20 border-t border-zinc-200/80 dark:border-zinc-800/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          {btech && (
            <div className="p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/70 shadow-xs hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-zinc-100 dark:border-zinc-800/80">
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 text-[11px] font-mono rounded bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
                        Graduated
                      </span>
                    </div>
                ...
                {/* Score Badge */}
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border border-emerald-500/20 font-mono text-xs font-bold self-start sm:self-auto shrink-0 shadow-2xs">
              ...
              {/* Meta strip */}
              <div className="pt-4 flex flex-wrap items-center gap-4 text-xs font-mono text-zinc-600 dark:text-zinc-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {secondarySchooling.map((edu) => (
              <div
                key={edu.id}
                className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/40 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all flex flex-col justify-between"
              >
                <div>
